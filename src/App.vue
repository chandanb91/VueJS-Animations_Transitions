        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <transition :name="alertAnimation">
                    <div class="alert alert-info" v-show="show">Some alert info</div>
                </transition>
                ...
                <transition :name="alertAnimation" mode="out-in">
                    <div class="alert alert-info" v-if="show" key="info">Some alert info</div>
                    <div class="alert alert-warning" v-else key="warning">Some alert warning</div>
                </transition>
                <hr>
                ...
                <button 
                        ...
                        @click="selectedComponent == 'app-success' ? 
                        selectedComponent = 'app-danger' : 
                        selectedComponent = 'app-success'">Toggle Component</button>
                        <br><br>
